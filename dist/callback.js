...
const aString = (toWrite, callback) => {
...
const downloadData = (url, callback) => {
    setTimeout(() => {
...
const randomResult = (success, error) => { Math.random() > 0.5 ? success("Success") : error("Error"); };
const showSuccess = (msg) => { console.log(msg); };
const showError = (msg) => { console.log(msg); };
const calculate = (a, b, op, callback) => {
    const operations = {
        add: (a, b) => a + b,
        subtract: (a, b) => a - b,
        multiply: (a, b) => a * b,
